...
namespace a3 {
	...
	u64 QueryImageSize(i32 w, i32 h, i32 channels, i32 bytesPerPixel, void* pixels);
	...
	a3::font LoadFontFromBuffer(void* buffer, f32 scale, void* destination);
