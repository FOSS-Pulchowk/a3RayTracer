/*
	...
	Modified by: Zero
	Modification details and LICENSE details are provided at the end of this file
...
extern int GladLoadGLLoader(GLADLoadProc load, gl_version* pGLVersion);
extern void* GladLoadGLFunction(GLADLoadProc load, const char* name);
...
/*
	OpenGL loader generated by glad 0.1.28 on Mon Jan  7 13:07:05 2019.
	Modified by: Zero
	Original Generator: https://github.com/Dav1dde/glad
	License of the software: https://github.com/Dav1dde/glad/blob/master/LICENSE

	Modification details are as follows:
	- Removed C support
	- Removed standard C libraries (in the original it used string.h, stdio.h and memory.h)
	- Removed dynamic library loading functions (done by the user itself & loader should be written by them)
	- Removed extension loader and added another, probably slower but according to my need
*/