...
struct m4x4
{
	...
	static m4x4 OrthographicR(f32 left, f32 right, f32 bottom, f32 top, f32 near, f32 far);
	...
	static m4x4 OrthographicC(f32 left, f32 right, f32 bottom, f32 top, f32 near, f32 far);
	static m4x4 PerspectiveC(f32 fov, f32 aspectRatio, f32 near, f32 far);
};
